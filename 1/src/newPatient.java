...
public class newPatient extends JFrame{
	...
	public newPatient() {
		...
		label2.setBounds(100, 80, 100, 20);
		label13.setBounds(100, 150, 100, 20);
		label3.setBounds(100, 220, 50, 20);
		label4.setBounds(100, 290, 50, 20);
		
		b1.setBounds(370, 350, 80, 35);
		
		firstName.setBounds(170, 80, 150, 25);
		lastName.setBounds(170, 150, 150, 25);
		gender.setBounds(170, 220, 150, 25);
		age.setBounds(170, 290, 150, 25);
		...
		b3.addActionListener(new ActionListener() {
	    	 ...
	    	 public void actionPerformed(ActionEvent arg0) {
	    		...
	    		newPatient.firstName = firstName.getText();
	    		newPatient.lastName = lastName.getText();
	    		newPatient.gender = gender.getText();
	    		newPatient.age = age.getText();
	    		newPatient.Weight = weight.getText();
	    		newPatient.Height = height.getText();
	    		newPatient.temp = temp.getText();
	    		newPatient.bp = bp.getText();
	    		newPatient.allergy = allergy.getText();
	    		newPatient.concern = concern.getText();	    		
	    		BackEnd newAdd = new BackEnd();
	    		newAdd.addPatient(newPatient);
//need an add patient function 		
